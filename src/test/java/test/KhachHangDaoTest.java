...
public class KhachHangDaoTest {
    ...
    @Test
    public void testThemKhachHang() throws Exception{
    ...
    @Test
    public void testGetDSKhachHang() throws Exception{
        // Call the method
    ...
    @Test
    public void testTimKhachHangTheoMa()throws Exception {
    ...
    @Test
    public void testTimKhachHangTheoTen() throws Exception{
    ...
    @Test
    public void testCapNhatKhachHang() throws Exception{
    ...
    @Test
    public void testTimKhachHangTheoSDT() throws Exception{
    ...
    @Test
    public void testGetListKhachHangByNameAndSDT() throws Exception{
    ...
    @Test
    public void testTimKhachHangBangSDT() throws Exception{
        // Define a known KhachHang phone number
        String sdt = "0323575911";
