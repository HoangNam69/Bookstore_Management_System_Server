...
public class ChiTietHoaDonDaoTest {
    ...
    @Test
    public void testGetCTHoaDonTheoMaHoaDon() throws Exception{
    ...
    @Test
    public void testGetCTHDTheoHoaDon() throws Exception{
    ...
    @Test
    public void testGetAllCTHD() throws Exception {
    ...
    @Test
    public void testAddChiTietHoaDon() throws Exception{
    ...
    @Test
    public void testGetTien() throws Exception{
        String maHD = "HD1300001";
