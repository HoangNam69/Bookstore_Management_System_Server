...
public class HoaDonDaoTest {
   private static HoaDonServiceImpl hoaDonDaoImpl;
    ...
    @Test
    void testSetNullChoMaNhanVienTrongHoaDon() throws Exception{
    ...
    @Test
    void testGetDSHoaDon() throws Exception{
    ...
    @Test
    void testDoiThongTinHoaDonSauKhiXoa()throws Exception {
        int result = hoaDonDaoImpl.doiThongTinHoaDonSauKhiXoa("someTenNV");
        assertEquals(1, result);
    }

    @Test
    void testThemHoaDon() throws Exception{
        try {
    ...
    @Test
    void testGetHoaDonTheoMa() throws Exception{
    ...
    @Test
    void testGetHoaDonThuong() throws Exception{
    ...
    @Test
    void testTimHoaDonTheoMa() throws Exception{
        HoaDon hoaDon = hoaDonDaoImpl.timHoaDonTheoMa("HD1300001");
        assertNotNull(hoaDon);
    }

    @Test
    void testGetHoaDonTheoTen() throws Exception{
    ...
    @Test
    void testTimHoaDonTheoSDT() throws Exception{
    ...
    @Test
    void testTimHoaDonTheoTenKH() throws Exception{
