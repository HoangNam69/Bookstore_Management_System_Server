...
public class HoaDonDoiTraDaoTest {
    ...
    @Test
    public void testThemHoaDonDoiTra() throws Exception {
    ...
    @Test
    public void testGetHoaDonDoiTraTheoMa() throws Exception{
    ...
    @Test
    public void testGetDSHoaDonDoiTra() throws Exception{
    ...
    @Test
    public void testEditTienKhachTra() throws Exception{
    ...
    @Test
    public void testEditTienPhaiTru() throws Exception{
        // Assume we are working with a known HoaDonDoiTra
        List<HoaDonDoiTra> hddtList = hoaDonDoiTraDao.getHoaDonDoiTraTheoMa("HDDT0001");
        assertNotNull(hddtList);
        assertFalse(hddtList.isEmpty());
    ...
    @Test
    public void testGetMaHoaDonDoiTraByMaHDCu() throws Exception{
    ...
    @Test
    public void testGetToanBoDSHoaDonDoiTra() throws Exception {
    ...
    @Test
    public void testTimHoaDonDoiTraTheoMa() throws Exception{
    ...
    @Test
    public void testGetHoaDonDoiTraTheoTen() throws Exception{
    ...
    @Test
    public void testGetHoaDonDoiTraTheoSDT() throws Exception{
    ...
    @Test
    public void testGetHoaDonDoiTraTheoTenKH() throws Exception {
